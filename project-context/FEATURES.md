...
| Shell logo/sidebar toggle polish | Done local / deploy pending | The separate Lucide left-sidebar toggle beside the YOU mark is removed. The smaller PixelYOU mark is now the sidebar toggle itself, and hover subtly swaps the logo into a two-line menu glyph. The right-pane toggle moved out of the left side of the top chrome and into the far-right top chrome using a cleaner minimal side-panel glyph |
