...
| Local host-tool bridge | Done | `you` / `youmd chat` now execute `start there` and generic local recent-work scans locally, then send the tool result through the remote model for the final response |
