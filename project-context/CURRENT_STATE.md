...
- Remaining portfolio graph work is richer strategy content, richer task editing
  fields, mobile/watch capture adapters, and deeper code/UI pattern mining. The
  Convex-backed graph, dashboard view, auditor skill, project-scoped MCP slice,
  repo-backed graph snapshots, update history, and CLI/API/MCP task/brain-dump
