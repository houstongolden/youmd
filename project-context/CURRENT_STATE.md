...
### CLI (youmd v0.6.17 — ready to publish)
...
- npm publish retry path is fixed: the next release target is `0.6.17`, package metadata is normalized, and the built CLI + MCP user-agent now match that version cleanly
