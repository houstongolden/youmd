...
| P2 | Resolve draft/publish semantics (save==publish w/ rollback patching profile, or true drafts) | PRODUCT-AUDIT #2; FEATURE-ROADMAP 1.2 | M | done (save==publish semantics documented in ARCHITECTURE.md; rollback→profiles patch shipped e3d4b01) |
