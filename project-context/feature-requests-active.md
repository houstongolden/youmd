...
4. Production proof. **DONE:** deployed and live-smoked public profile; production `/shell` unauth correctly redirects to sign-in; authenticated Chrome QA verified shell render, sidebar expansion, and zero console errors after the greeting hydration fix.
