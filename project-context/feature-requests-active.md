...
5. Port relevant h.computer source adapters into You.md-native connectors: school Google Doc crawler, tasks/calendar, historical daily log, weather, surf report, GitHub project/LOC/LOMB/recent updates, research/blog crawlers. **PARTIAL:** weather + Venice Breakwater surf and the first GitHub project catalog now refresh into private DSI components and source snapshots. GitHub catalog includes tracked projects, GitHub URLs, matched project URLs, recent commits, stars, AI insight, visibility, and exact repo-mirror LOC/LOMB where available. **PENDING:** school, tasks/calendar, historical daily log, full per-repo GitHub `/languages` LOC/LOMB enrichment, research/blog crawlers.
