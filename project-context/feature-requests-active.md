...
6. Add custom crawlers, crons, source refresh, monitored updates, source health, and provenance-rich writeback. **PARTIAL CODE COMPLETE:** source metadata, hourly due-source marker cron, owner source actions, and native/Firecrawl pipeline dispatch are added; agent-browser fails closed until the sandbox runner is designed.
