...
13. Expose inventory topology through You.md API and MCP so authorized agents can inspect and repair drift. **PARTIAL:** authenticated API post/list routes exist for safe summaries. **OPEN:** MCP tools/resources and richer topology/drift query models.
