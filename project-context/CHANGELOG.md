...
- Verified the served local script via `curl http://localhost:3100/install.sh`, `/bin/bash -n`, and a fake-home npm-channel install without needing `YOUMD_FORCE_USER_NPM_PREFIX=1`.
