...
- Added localhost-only `POST /api/local/skill-mesh-repair` and a compact `run repair on this Mac` / `refresh proof on this Mac` control for whitelisted local `you` repair actions.
