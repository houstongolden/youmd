...
- The final response names what changed and what still needs production/user verification.`,
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "```bash",
      "youmd machine prompt --root ~/Desktop/CODE_YOU --days 90 --limit 80 --require-env-vault",
      "```",
      "",
      ...
      "",
      "```bash",
      "YOUMD_PORTFOLIO_HYDRATE_TIMEOUT_SECONDS=300 youmd machine prompt --root ~/Desktop/CODE_YOU --days 90 --limit 80 --require-env-vault",
      "```",
      "",
