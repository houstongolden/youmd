/**
 * Canonical capability router — Convex side.
 *
 ...
 *
 * A CLI-side twin lives at cli/src/lib/capability-router.ts.
 * Both are pinned to the same JSON fixture: convex/__fixtures__/capability-router-cases.json.
 *
 * Behavior must remain identical to the CLI twin — do not add logic here
 * without mirroring it there (and vice-versa). The fixture enforces parity.
 *
 * P18 (2026-06-12)
 */
 ...
 * text routing is a separate concern handled by routeYouStackCapability.
 */
