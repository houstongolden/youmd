...
// layout (src/app/layout.tsx); scoped polish from ./desktop-demo/desktop-demo.css.
import "./desktop-demo/desktop-demo.css";
...
export default function DesktopLayout({
  ...
  return (
    <div className="youmd-desktop h-[100dvh] w-screen overflow-hidden bg-[hsl(var(--bg))] text-[hsl(var(--text-primary))]">
      {children}
    </div>
  );
}
