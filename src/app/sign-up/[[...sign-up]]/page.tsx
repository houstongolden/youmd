...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative bg-background overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-sky/[0.04] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8 w-full max-w-md px-6">
        ...
        <SignUp
          ...
          fallbackRedirectUrl="/claim"
        />

        {/* Sign-in link */}
        <p className="text-sm text-foreground-secondary">
          Already have an account?{" "}
          <Link href="/sign-in" className="text-sky hover:text-coral transition-colors font-medium">
            Sign in
          </Link>
        </p>
      </div>
