              ...
              <div className="hidden md:block relative" ref={dropdownRef}>
                ...
                {avatarDropdown && (
                  <div className="absolute right-0 top-full mt-2 w-44 border border-[hsl(var(--border))] bg-[hsl(var(--bg-raised))] py-1 z-50" style={{ borderRadius: "2px" }}>
                    <Link href="/shell" onClick={() => setAvatarDropdown(false)} className="block px-3 py-1.5 font-mono text-[11px] text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--accent))]/5 transition-colors">
                      &gt; shell
                    </Link>
                    {username && (
            ...
            <div className="relative mt-4" ref={mobileDropdownRef}>
              ...
              {mobileAvatarDropdown && (
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-48 border border-[hsl(var(--border))] bg-[hsl(var(--bg-raised))] py-1 z-50" style={{ borderRadius: "2px" }}>
                  <Link href="/shell" onClick={() => { setMobileAvatarDropdown(false); setMobileOpen(false); }} className="block px-3 py-2 font-mono text-[12px] text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--text-primary))] hover:bg-[hsl(var(--accent))]/5 transition-colors">
                    &gt; shell
                  </Link>
                  {username && (
