/**
 * Canonical capability router — Next.js / src side.
 *
 ...
 *
 * Behavior must remain identical across all three — do not add logic here
 * without mirroring it in the CLI and Convex twins (and vice-versa).
 * The fixture enforces parity.
 *
 * P18 (2026-06-12)
 */
